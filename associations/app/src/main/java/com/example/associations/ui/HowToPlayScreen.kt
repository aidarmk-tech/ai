...
fun HowToPlayScreen(onBack: () -> Unit) {
    Column(
        ...
        Section(
            "Цель",
            "Разложить все 24 карты по основаниям. Каждое основание — это одна " +
                "категория (Города, Мебель, Животные, Еда), карты кладутся по " +
                "возрастанию ассоциативного ранга 1→6."
        )
        Section(
            "Ранг = ассоциация",
            "Внутри категории у карты есть порядок: города по населению, мебель и " +
                "животные по размеру, еда по «тяжести». Ранг показан цифрой в углу карты."
        )
        Section(
            "Ходы",
