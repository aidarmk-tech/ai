package com.lampa.player.iptv

import android.content.Intent
import android.os.Bundle
import android.view.KeyEvent
import androidx.appcompat.app.AppCompatActivity
import com.lampa.player.databinding.ActivityIptvBinding
import com.lampa.player.epg.EpgActivity
...
class IptvActivity : AppCompatActivity() {
    ...
    private fun openPlayer(channel: Channel) {
        val intent = Intent(Intent.ACTION_VIEW).apply {
            setClassName(packageName, "com.lampa.player.player.PlayerActivity")
...
class GroupAdapter(
    ...
    inner class VH(val view: android.view.View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view) {
        val tvName: android.widget.TextView = view.findViewById(com.lampa.player.R.id.tv_group_name)
        val indicator: android.view.View = view.findViewById(com.lampa.player.R.id.group_indicator)
    }

    override fun onCreateViewHolder(parent: android.view.ViewGroup, viewType: Int): VH {
        val v = android.view.LayoutInflater.from(parent.context).inflate(com.lampa.player.R.layout.item_channel_group, parent, false)
        return VH(v)
    }
...
class ChannelAdapter(
    ...
    inner class VH(val view: android.view.View) : androidx.recyclerview.widget.RecyclerView.ViewHolder(view) {
        val tvNumber: android.widget.TextView = view.findViewById(com.lampa.player.R.id.tv_channel_number)
        val tvName: android.widget.TextView = view.findViewById(com.lampa.player.R.id.tv_channel_name)
        val tvShow: android.widget.TextView = view.findViewById(com.lampa.player.R.id.tv_current_show)
        val ivLogo: android.widget.ImageView = view.findViewById(com.lampa.player.R.id.iv_channel_logo)
    }

    override fun onCreateViewHolder(parent: android.view.ViewGroup, viewType: Int): VH {
        val v = android.view.LayoutInflater.from(parent.context).inflate(com.lampa.player.R.layout.item_channel, parent, false)
        return VH(v)
    }
